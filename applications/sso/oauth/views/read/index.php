...
namespace applications\sso\oauth\views\read;
...
use applications\sso\oauth\forms\Delete;
...
$oauth_delete = new Delete();
$oauth_delete = $oauth_delete->human();
...
<script type="text/javascript">
    ...
    window.page.tables = {
        ...
        oauth_delete: <?= Output::json($oauth_delete); ?>
    };
</script>
...
<link rel="stylesheet" type="text/css" href="/cdn/applications/sso/oauth/views/read/1.0.0/css/base.css">

<!-- JS View -->

<script src="/cdn/applications/sso/oauth/views/read/1.0.0/js/base.js"></script>
