...
namespace applications\sso\server\views\read;
...
use applications\sso\cluster\forms\Delete;
...
$server_delete = new Delete();
$server_delete = $server_delete->human();
...
<script type="text/javascript">
    ...
    window.page.tables = {
        server: <?= Output::json($server); ?>,
        server_delete: <?= Output::json($server_delete); ?>
    };
</script>
...
<link rel="stylesheet" type="text/css" href="/cdn/applications/sso/server/views/read/1.0.0/css/base.css">

<!-- JS View -->

<script src="/cdn/applications/sso/server/views/read/1.0.0/js/base.js"></script>
