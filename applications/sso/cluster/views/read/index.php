...
namespace applications\sso\cluster\views\read;
...
$cluster_delete = new Delete();
$cluster_delete = $cluster_delete->human();
...
<script type="text/javascript">
    ...
    window.page.tables = {
        ...
        cluster_delete: <?= Output::json($cluster_delete); ?>
    };
</script>
...
<link rel="stylesheet" type="text/css" href="/cdn/applications/sso/cluster/views/read/1.0.0/css/base.css">

<!-- JS View -->

<script src="/cdn/applications/sso/cluster/views/read/1.0.0/js/base.js"></script>
