(function (window) {
    ...
    for (let item = 0; item < window.page.tables.cluster.fields.length; item++) widgets.form.addInput(window.page.tables.cluster.fields[item]);
    ...
    let create_api = '/api/sso/cluster/create'
        + String.fromCharCode(63)
        + 'timestamp'
        + String.fromCharCode(61)
        + Date.now();
    ...
    let update_api = '/api/sso/cluster/update'
    ...
    let main = new WXmlHttpRequest(),
        detail_api = '/api/sso/cluster/detail'
            + String.fromCharCode(47)
            + encodeURIComponent(window.reference[0])
            + String.fromCharCode(63)
            + 'timestamp'
