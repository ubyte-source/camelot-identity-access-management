...
namespace applications\iam\group\views\read;
...
use applications\iam\group\forms\Delete;
...
$group_delete = new Delete();
$group_delete = $group_delete->human();
...
<script type="text/javascript">
    ...
    window.page.tables = {
        ...
        group_delete: <?= Output::json($group_delete); ?>
    };
</script>
...
<link rel="stylesheet" type="text/css" href="/cdn/applications/iam/group/views/read/1.0.0/css/base.css">

<!-- JS View -->

<script type="text/javascript" src="/cdn/applications/iam/group/views/read/1.0.0/js/base.js"></script>
